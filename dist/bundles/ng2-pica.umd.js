(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('exif-js/exif'), require('rxjs'), require('pica/dist/pica')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'exif-js/exif', 'rxjs', 'pica/dist/pica'], factory) :
    (factory((global['ng2-pica'] = {}),global.ng.core,null,global.Rx,null));
}(this, (function (exports,core,exif,rxjs,pica) { 'use strict';
    ...
    var Ng2PicaService = /** @class */ (function () {
        ...
        Ng2PicaService.ctorParameters = function () { return [
            { type: ImgExifService, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return ImgExifService; }),] }] }
        ]; };
